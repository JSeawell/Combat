...
int BlueMen::attack()
{
    ...
    cout << "BlueMen roll: " << ad1 << ", " << ad2 << endl;
    int attackDamage = (ad1 + ad2);
    cout << "BlueMen attacking with--> " << attackDamage << endl;
    return attackDamage;
}
...
int BlueMen::defend(int attackDamage)
{
    if (strength <= 0)
    {
        cout << "BlueMen are already dead." << endl;
    }
    else if (attackDamage == 100)
    {
        cout << "BlueMen were instantly turned to stone." << endl;
        strength = 0;
    }
    else
    {
        ...
        if (strength > 8)
        {
            ...
            d2 = minMaxRand(1,6);
            d3 = minMaxRand(1,6);
            cout << "BlueMen defend with 3 dice because of special ability: 'Mob'. They roll: " << d1 << ", " << d2 << ", " << d3 << endl;
        }
        else if (strength <= 8 && strength > 4)
        {
            d1 = minMaxRand(1,6);
            d2 = minMaxRand(1,6);
            cout << "BlueMen defend: Because of special ability: 'Mob', BlueMen are down 1 man, and only defend with 2 dice." << endl;
	    cout << "BlueMen roll: " << d1 << ", " << d2 << endl;
        }
        else if (strength <= 4)
        {
            d1 = minMaxRand(1,6);
            cout << "BlueMen defend: Because of special ability: 'Mob', BlueMen are down two men." << endl;
	    cout << "They are down to their last man, and only defend with one die!" << endl;
	    cout << "BlueMen roll: " << d1 << endl;
        }
        
        int defense = (d1 + d2 + d3);
        cout << "BlueMen defend with: " << defense << endl;
	...
	cout << "BlueMen strength before: " << strength << endl;
        ...
        cout << "BlueMen strength left: " << strength << endl;
        
        if (strength == 0)
            cout << "All the BlueMen died." << endl;
    }
    return strength;
}
